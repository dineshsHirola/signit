      ...
      await axios
        ...
        .then((result) => {
          if (result.data.Status === 'Success') {
            ...
            try {
              axios
                .get('http://localhost:8000/admin/cef')
                .then((result) => {
                  if (result.data.Status === 'Success') {
              ...
              <div className="main-div">
                <Container>
                  <div className="headflex">
                    <h1 className="heading">Application To Cancel Enrolment Data</h1>
                    <input type="search" placeholder="Search by Course Code" onChange={(e)=>{setSearch(e.target.value)}}/>
                  </div>
                  <Table
